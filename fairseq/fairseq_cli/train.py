...
def train(
    ...
    for i, samples in enumerate(progress):
        with metrics.aggregate("train_inner"), torch.autograd.profiler.record_function(
            ...
            # # print('>> ', samples)
            if print_example:
                print('>> src:', task.dictionary.string(samples[0]['net_input']['src_tokens'][0]))
                print('>> tgt:', task.dictionary.string(samples[0]['net_input']['prev_output_tokens'][0]))
                print('>> src:', samples[0]['net_input']['src_tokens'][0])
                print('>> tgt:', samples[0]['net_input']['prev_output_tokens'][0])
                print_example = False
            # assert False
