...
class BARTModel(TransformerModel):
    ...
    def __init__(self, args, encoder, decoder):
        ...
        if hasattr(self.encoder, "dictionary"):
            ...
            self.mask: int = self.encoder.dictionary.index("{}".format("<mask>"))
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # mBART for sentence prediction
        return BARTHubInterface(x["args"], x["task"], x["models"][0], src_lid, tgt_lid)
