...
class LSTMModel(FairseqEncoderDecoderModel):
    def __init__(self, args, encoder, decoder):
        ...
        self.args = args
        self.args.add_prev_output_tokens = True
...
def Embedding(num_embeddings, embedding_dim, padding_idx):
    ...
    nn.init.uniform_(m.weight, -0.05, 0.05) # FIXED
...
def base_architecture(args):
    ...
    # args.encoder_layers = getattr(args, "encoder_layers", 1) FIXED
    # args.encoder_bidirectional = getattr(args, "encoder_bidirectional", False) FIXED
    ...
    # args.decoder_layers = getattr(args, "decoder_layers", 1) FIXED
