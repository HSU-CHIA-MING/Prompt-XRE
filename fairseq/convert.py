...
from transformers.modeling_xlm_roberta import XLMRobertaConfig, XLMRobertaForMaskedLM, XLMRobertaForSequenceClassification
...
def convert_roberta_checkpoint_to_pytorch(
    ...
    if classification_head:
        config.num_labels = roberta.model.args.num_classes
    print("Our BERT config:", config)

    model = XLMRobertaForSequenceClassification(config) if classification_head else XLMRobertaForMaskedLM(config)
    model.eval()
